...
class InformativePriorModelDirect:
    """
    ...
    This implementation directly implements the PriorModel Protocol without
    inheriting from BasePriorModel.
    ...
    Attributes:
        ...
        u_scale_loc (float): Location parameter for u_scale prior distribution.
        u_scale_scale (float): Scale parameter for u_scale prior distribution.
        s_scale_loc (float): Location parameter for s_scale prior distribution.
        s_scale_scale (float): Scale parameter for s_scale prior distribution.
        dt_switching_loc (float): Location parameter for dt_switching prior distribution.
        dt_switching_scale (float): Scale parameter for dt_switching prior distribution.
    """

    name = "informative_direct"
    ...
    def __init__(
        ...
        """
        Initialize the InformativePriorModelDirect.
    ...
    def forward(
        ...
        # Check if we should include prior distributions
        # This is used to disable priors during guide execution
        include_prior = context.get("include_prior", True)
