...
class PyroVelocityModel:
    ...
    def get_velocity(
        ...
        **kwargs
        ...
        It first generates posterior samples if they are not provided, then computes
        velocity using the compute_velocity function from the inference.posterior module.
