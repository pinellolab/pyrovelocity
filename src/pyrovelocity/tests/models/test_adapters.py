...
def sample_adata():
    ...
    adata.layers["spliced"] = np.random.negative_binomial(5, 0.3, size=(n_obs, n_vars))
    adata.layers["unspliced"] = np.random.negative_binomial(3, 0.3, size=(n_obs, n_vars))
...
class TestConfigurationAdapter:
    ...
    def test_legacy_to_modular_config(self):
        ...
        modular_config = ConfigurationAdapter.legacy_to_modular_config(legacy_params)
        ...
        assert modular_config.dynamics_model.params["cell_specific_kinetics"] is None
    ...
    def test_modular_to_legacy_config(self):
        ...
        legacy_params = ConfigurationAdapter.modular_to_legacy_config(modular_config)
...
class TestLegacyModelAdapter:
    ...
    def test_from_modular_model(self, sample_adata):
        ...
        adapter = LegacyModelAdapter.from_modular_model(sample_adata, modular_model)
