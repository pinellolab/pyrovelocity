...
def test_nonlinear_dynamics_model_saturation():
    ...
    ut_high, st_high = nonlinear_dynamics_model(tau, u0, s0, params_high_scaling)
...
def test_vectorized_standard_dynamics_model():
    ...
    ut_standard, st_standard = standard_dynamics_model(tau, u0, s0, params)
    ut_vectorized, st_vectorized = vectorized_standard_dynamics_model(tau, u0, s0, params)
...
def test_vectorized_nonlinear_dynamics_model():
    ...
    ut_vectorized, st_vectorized = vectorized_nonlinear_dynamics_model(tau, u0, s0, params)
...
def test_vectorized_dynamics_ode_model():
    ...
    ut_vectorized, st_vectorized = vectorized_dynamics_ode_model(tau, u0, s0, params)
