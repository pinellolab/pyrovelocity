...
adata_model_pos_split = train_model(adata_input, max_epochs=1000, svi_train=True, lr=0.01,
                              patient_init=45, batch_size=4000, use_gpu=1, log_every=100,
...
def check_shared_time(adata_model_pos, adata):
    ...
    fig.savefig("fig3_all_test_sub_model1.pdf", facecolor=fig.get_facecolor(),
...
fig.savefig("fig3_all_test_volcano_sub.pdf", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
...
fig.savefig("fig3_all_test_rainbow_sub_model1.pdf", facecolor=fig.get_facecolor(),
            bbox_inches='tight', edgecolor='none', dpi=300)

fig, ax = plt.subplots()
embed_mean = plot_mean_vector_field(adata_model_pos_split[1], adata_input,
                                    ax=ax, basis='emb')
fig.savefig("fig3_test_vecfield_sub_model1.pdf", facecolor=fig.get_facecolor(),
            bbox_inches='tight', edgecolor='none', dpi=300)
