...
fig = denoised_umap(adata_model_pos_all, adata_input_all, cell_state='state_info', n_jobs=30)
fig.savefig("larry_multifate_supp6.pdf", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)

from dynamical_velocity2.plot import denoised_umap
fig2 = denoised_umap(adata_model_pos, adata, cell_state='clusters')
fig2.savefig("pancreas_supp6.pdf", facecolor=fig2.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
