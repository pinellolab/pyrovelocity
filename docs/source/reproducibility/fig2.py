...
fig.savefig("Fig2_pancreas_raw_gene_selection_model1.tif", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)

fig.savefig("Fig2_pancreas_raw_gene_selection_model1.svg", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
