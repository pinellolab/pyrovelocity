...
def check_shared_time(adata_model_pos, adata):
    ...
    fig.savefig("fig2_test_sub_model2.pdf", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
...
fig.savefig("fig2_test_volcano_sub_model2.pdf", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
...
fig.savefig("fig2_test_rainbow_sub_model2.pdf", facecolor=fig.get_facecolor(), bbox_inches='tight', edgecolor='none', dpi=300)
...
adata.write("fig2_pancreas_processed_model2.h5ad")

adata_model_pos[0].save('Fig2_pancreas_model2', overwrite=True)
result_dict = {"adata_model_pos": adata_model_pos[1], "v_map_all": v_map_all, "embeds_radian": embeds_radian, "fdri": fdri, "embed_mean": embed_mean}
import pickle

with open("fig2_pancreas_data_model2.pkl", "wb") as f:
    pickle.dump(result_dict, f)
