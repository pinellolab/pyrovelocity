...
The sources for pyrovelocity can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/qinqian/pyrovelocity
.. _tarball: https://github.com/qinqian/pyrovelocity/tarball/master
