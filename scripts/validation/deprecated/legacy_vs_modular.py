#!/usr/bin/env python
"""
Legacy vs Modular Validation Script for PyroVelocity.
...
Example usage:
    ...
    python legacy_vs_modular.py --max-epochs 500 --num-samples 50
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Legacy vs Modular Validation Script for PyroVelocity"
    )
    parser.add_argument(
        "--max-epochs",
        type=int,
...
def prepare_data(n_cells=100, n_genes=100, seed=42):
...
def generate_summary_report(validation_results, args, output_dir):
    ...
    with open(report_path, "w") as f:
        f.write("PyroVelocity Validation Summary Report\n")
        f.write("====================================\n\n")
...
def main():
    ...
    adata = prepare_data(n_cells=args.n_cells, n_genes=args.n_genes, seed=args.seed)
