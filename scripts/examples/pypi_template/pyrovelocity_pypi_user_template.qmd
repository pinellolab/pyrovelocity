...
```{python}
#| label: print-pyrovelocity-docstring
...
<!-- ![Maximum spliced and unsliced transcript counts data for each gene across all cells with marginal histograms.](data/processed/pancreas_thresh_histogram.pdf.png){#fig-raw-counts} -->
```{python}
...
<!-- ![Vector field](reports/pancreas_model2/vector_field.pdf.png){#fig-vector-field} -->
```{python}
...
<!-- ![Vector fields with uncertainty estimates](reports/pancreas_model2/fig2_part1_plot.pdf.png){#fig-vector-fields-uncertainty} -->
```{python}
...
<!-- ![RNA velocity volcano plot showing mean absolute error versus shared time correlation for each gene](reports/pancreas_model2/volcano.pdf.png){#fig-volcano} -->
```{python}
#| label: fig-volcano
#| echo: false
...
<!-- ![Splice state phase portraits, estimated expression levels over shared time, and shared time correlation for a subset of selected genes](reports/pancreas_model2/rainbow.pdf.png){#fig-rainbow} -->
```{python}
#| label: fig-rainbow
#| echo: false
...
<!-- ![Summary of gene selection results](reports/pancreas_model2/fig2_part2_plot.pdf.png){#fig-gene-selection-summary} -->
```{python}
...
<!-- ![Centered parameter uncertainties for a subset of genes](reports/pancreas_model2/parameter_uncertainties.pdf.png){#fig-parameter-uncertainty} -->
```{python}
...
<!-- 
TODO: save png copy of shared time plot
#### Shared time

@fig-shared-time-uncertainty shows the uncertainty in the shared time estimates for each gene.

![Uncertainty in the shared time estimates for each gene](reports/pancreas_model2/shared_time.pdf){#fig-shared-time-uncertainty} 
-->
