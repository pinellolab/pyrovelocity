...
This document provides a brief overview of what Pyro-Velocity is and how it can be used.
See

- [Installation](/guides/installation.qmd) for installation instructions or
...
For end-user oriented (i.e. not for development but rather execution)
installation please see the [installation guide](../guides/installation.qmd).
For development installation please see the [contributing guide](../about/contributing.qmd).
...
An [IaC](https://en.wikipedia.org/wiki/Infrastructure_as_code) setup that works with [GCP](https://registry.terraform.io/providers/hashicorp/google/latest/docs) is documented in [reproducibility/environment/README.md](https://github.com/pinellolab/pyrovelocity/blob/main/reproducibility/environment/README.md).
...
Also see [contributing](../about/contributing.qmd).
