...
# Plot 2: Alternative model comparison (if computed)
if 'velocity_primary_legacy2' in adata_primary.layers:
    scv.pl.velocity_embedding_grid(
        adata_primary,
        basis='umap',
        color='leiden',
        title='PyroVelocity Primary Legacy Model',
        vkey='velocity_primary_legacy2',
        s=15,
        alpha=1,
        linewidth=0.5,
        ax=axes[1],
    ...
    axes[1].text(0.5, 0.5, 'Alternative model\nnot computed',
