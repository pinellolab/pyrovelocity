...
"""Loads multilineage data and trains and saves model1 model.

Inputs:
  "data/larry_mono.h5ad" via load_unipotent_larry()
...
Outputs:
  ...
  models:
    Fig3_uni_bifurcation_model1/
    ├── attr.pkl
    ├── model_params.pt
    ├── param_store_test.pt
    └── var_names.csv
  figures:
    "fig3_uni_bifurcation_vectorfield_model1.pdf"
"""
